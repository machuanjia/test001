 ...
 * @LastEditTime: 2022-02-28 18:09:19
 * @FilePath: /main/src/views/Penetrate/index.tsx
 * @Description:
 */
...
const Penetrate = () => {
  ...
  return (
    <ContentLayout hLeft={<OtterTableTitle title="洞察" count={0} />} hRight={<Actions />}>
      <OtterTable
        locale={{
          emptyText: (
            <Empty
              title="洞察"
              description="洞察功能从多个维度提供对模型线上服务效果的分析，帮助企业发现模型存在的问题，沉淀数据、不断优化模型效果。"
            />
          ),
        }}
        loading={false}
