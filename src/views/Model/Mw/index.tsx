 ...
 * @LastEditTime: 2022-02-28 18:04:41
 * @FilePath: /main/src/views/Model/Mw/index.tsx
 * @Description:
 */
...
const ModelW = () => {
  ...
  return <ContentLayout hLeft={<OtterTableTitle title='模型仓库' count={0} />} hRight={<Actions />}>
    <OtterTable locale={{
      emptyText: <Empty
        title="模型仓库"
        description="模型仓库管理主流框架所导出的模型文件。能够进行版本控制和导入导出。"
      />
    }} loading={false} dataSource={[]} columns={columns} />
  </ContentLayout>
}
export default ModelW
